                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 sm:gap-12 items-start">
                        ...
                        <form onSubmit={handleOrder} className="space-y-4 sm:space-y-5">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    <label className="text-xs sm:text-sm font-bold text-husk/70 ml-1 uppercase tracking-wider">Your Name</label>
                                    <input
                                        required
                                        name="name"
                                        value={formData.name}
                                ...
                                <div className="space-y-1">
                                    <label className="text-xs sm:text-sm font-bold text-husk/70 ml-1 uppercase tracking-wider">Mobile Number</label>
                                    <input
                                        required
                                        name="phone"
                            ...
                            <div className="space-y-1">
                                <label className="text-xs sm:text-sm font-bold text-husk/70 ml-1 uppercase tracking-wider">Full Address</label>
                                <textarea
                                    required
                                    name="address"
                            ...
                            <div className="space-y-4 pt-2">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                    <div className="bg-primary/5 p-4 rounded-xl sm:rounded-2xl border border-primary/10 flex flex-col justify-center">
                                        <p className="text-[10px] font-black text-primary uppercase tracking-widest mb-1.5">Option 1: bKash</p>
                                        <p className="text-[11px] sm:text-xs text-husk font-bold leading-relaxed">
                                            ...
                                            Write <span className="underline decoration-primary/30 underline-offset-2">TrxID</span> in note.
                                        </p>
                                    </div>

                                    <div className="bg-accent/10 p-4 rounded-xl sm:rounded-2xl border border-accent/20 flex flex-col justify-center">
                                        <p className="text-[10px] font-black text-accent-dark uppercase tracking-widest mb-1.5">Option 2: COD</p>
                                        <p className="text-[11px] sm:text-xs text-husk font-bold leading-relaxed">
                                            Prefer COD? Write <span className="text-accent-dark font-black">"Cash on Delivery"</span> in the note.
                                        </p>
                                    </div>
                                </div>

                                <div className="space-y-1">
                                    <label className="text-xs sm:text-sm font-bold text-husk/70 ml-1 uppercase tracking-wider">Order Note</label>
                                    <textarea 
                                        name="note"
                                        value={formData.note}
                                        onChange={handleInputChange}
                            ...
                            <div className="flex items-start gap-3 p-1">
                                ...
                                />
                                <label htmlFor="terms" className="text-xs sm:text-sm font-bold text-husk/60 cursor-pointer select-none leading-snug">
                                    I confirm that my information is correct and I agree to the <span className="text-primary underline">Terms</span>.
                                </label>
                            </div>
                    ...
                    >
                        <div className="bg-white p-6 sm:p-8 rounded-[2rem] shadow-xl border border-secondary/5">
                            <h3 className="text-xl font-black text-husk mb-6 border-b pb-4 text-center lg:text-left">Order Summary</h3>
                            ...
                            <div className="flex gap-4 items-center pb-6 border-b border-dashed">
                                ...
                                <div className="flex flex-col items-end gap-2">
                                    <div className="flex items-center bg-slate-50 rounded-lg p-1 border">
                                        ...
                                        <span className="w-6 sm:w-8 text-center font-black text-sm text-husk">{quantity}</span>
                                        <button
                            ...
                            <div className="space-y-4 pt-6">
                                ...
                                {quantity >= 5 && (
                                    ...
                                    >
                                        ...
                                        <span className="text-xs font-black text-accent-dark">- ৳{quantity * 30} Saved</span>
                                    </motion.div>
                                )}
                        ...
                        <div className="bg-primary p-6 rounded-[2rem] text-white shadow-xl shadow-primary/20 flex items-center gap-4">
                            ...
                            <div>
                                <h4 className="font-black text-sm sm:text-base leading-tight">Buy More, Save More!</h4>
                                <p className="text-xs text-white/80 mt-1">৳570/box for 5+ orders</p>
                            </div>
                        </div>
                    </motion.div>
