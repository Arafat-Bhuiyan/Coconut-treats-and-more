              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="rounded-xl px-4 py-4 flex flex-col items-center justify-center gap-1 relative overflow-hidden" style={{background: 'linear-gradient(135deg, #4A6741 0%, #5A7336 100%)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: '1px solid rgba(255,255,255,0.35)', boxShadow: '0 6px 20px rgba(74, 103, 65, 0.35), inset 0 1px 0 rgba(255,255,255,0.45)'}}>
                  ...
                  <div className="flex items-center gap-2 relative z-10">
                    ...
                    <span className="text-xl sm:text-2xl font-black leading-tight" style={{color: '#fff', textShadow: '0 2px 6px rgba(0,0,0,0.4)', letterSpacing: '-0.01em'}}>
                      Instant Discount
                    </span>
                  </div>
