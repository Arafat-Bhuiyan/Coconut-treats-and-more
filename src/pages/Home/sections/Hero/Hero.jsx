        ...
        <section className="pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 min-h-[90vh] md:min-h-screen flex items-center bg-milk-white overflow-hidden">
            <div className="container mx-auto grid md:grid-cols-2 gap-10 md:gap-12 items-center">
                ...
                >
                    ...
                    <img src={logo} alt="Logo" className="w-[8rem] h-[8rem] sm:w-[12rem] sm:h-[12rem] mx-auto md:mx-0 mb-4 sm:mb-6" />
                    ...
                    <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black text-husk leading-[1.1] mb-6">
                        Fresh Homemade <br />
                    ...
                    <div className="space-y-5 mb-8 max-w-lg mx-auto md:mx-0">
                        <p className="text-base sm:text-lg text-husk/80 leading-relaxed">
                            Made with <span className="text-primary font-bold">fresh coconut water</span>, <span className="text-primary font-bold">authentic cow milk</span>, and <span className="text-primary font-bold">imported agar-agar</span>.
                        </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6 justify-center md:justify-start">
                        <a href="#order" className="w-full sm:w-auto bg-primary hover:bg-primary-dark text-white font-black py-4 px-10 rounded-2xl transition-all shadow-2xl shadow-primary/30 text-center text-lg transform hover:-translate-y-1">
                            Order Now
                        </a>
                        <div className="flex items-center gap-3">
                            <div className="flex -space-x-2">
                                {[1, 2, 3, 4].map((i) => (
                                    <div key={i} className="w-9 h-9 sm:w-10 sm:h-10 rounded-full border-2 border-white bg-slate-200 shadow-sm overflow-hidden">
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            <p className="text-[10px] sm:text-xs text-husk/50 uppercase font-black tracking-widest">Made Fresh</p>
